...
<!--        <template slot-scope="scope">-->
<!--          <dict-tag :options="dict.type.${column.dictType}" :value="scope.row.name"/>-->
<!--        </template>-->
      </el-table-column>
      <el-table-column label="教师电话" align="center" prop="phone">
<!--        <template slot-scope="scope">-->
<!--          <dict-tag :options="dict.type.${column.dictType}" :value="scope.row.phone"/>-->
<!--        </template>-->
      </el-table-column>
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="教师电话" prop="phone">
          <el-input v-model="form.phone" placeholder="请输入教师电话" />
        </el-form-item>
      </el-form>
