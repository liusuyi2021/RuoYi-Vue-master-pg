...
INSERT INTO "public"."sys_config" VALUES (4, '账号自助-验证码开关', 'sys.account.captchaEnabled', 'true', 'Y', 'admin', '2023-01-11 08:15:26', '', NULL, '是否开启验证码功能（true开启，false关闭）');
...
-- ----------------------------
INSERT INTO "public"."sys_logininfor" VALUES (200, 'admin', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '登录成功', '2023-01-11 10:02:00.090414');
INSERT INTO "public"."sys_logininfor" VALUES (201, 'admin', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '登录成功', '2023-01-11 10:04:51.891983');
INSERT INTO "public"."sys_logininfor" VALUES (202, 'admin', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '登录成功', '2023-01-11 10:05:43.626873');
INSERT INTO "public"."sys_logininfor" VALUES (203, 'admin', '192.168.3.8', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2023-01-11 10:07:18.956461');
INSERT INTO "public"."sys_logininfor" VALUES (204, 'admin', '192.168.3.8', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2023-01-11 11:14:05.586053');
INSERT INTO "public"."sys_logininfor" VALUES (205, 'admin', '192.168.3.8', '内网IP', 'Chrome 9', 'Windows 10', '0', '退出成功', '2023-01-11 13:07:24.16205');
INSERT INTO "public"."sys_logininfor" VALUES (206, 'admin', '192.168.3.8', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2023-01-11 13:07:27.833893');
INSERT INTO "public"."sys_logininfor" VALUES (207, 'admin', '192.168.3.8', '内网IP', 'Chrome 9', 'Windows 10', '0', '退出成功', '2023-01-11 14:43:36.376038');
INSERT INTO "public"."sys_logininfor" VALUES (208, 'admin', '192.168.3.8', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2023-01-11 14:43:40.063531');
INSERT INTO "public"."sys_logininfor" VALUES (209, 'admin', '192.168.3.8', '内网IP', 'Chrome 9', 'Windows 10', '0', '退出成功', '2023-01-11 14:47:31.860511');
INSERT INTO "public"."sys_logininfor" VALUES (210, 'admin', '192.168.3.8', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2023-01-11 14:47:39.080227');
INSERT INTO "public"."sys_logininfor" VALUES (211, 'admin', '192.168.3.8', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2023-01-11 15:50:42.569639');
...
-- ----------------------------
INSERT INTO "public"."sys_oper_log" VALUES (253, '操作日志', 9, 'com.ruoyi.web.controller.monitor.SysOperlogController.clean()', 'DELETE', 1, 'admin', NULL, '/monitor/operlog/clean', '192.168.3.8', '内网IP', '{}', '{"msg":"操作成功","code":200}', 0, NULL, '2023-01-11 15:11:47.434092');
INSERT INTO "public"."sys_oper_log" VALUES (254, '代码生成', 6, 'com.ruoyi.generator.controller.GenController.importTableSave()', 'POST', 1, 'admin', NULL, '/tool/gen/importTable', '192.168.3.8', '内网IP', '"student"', NULL, 1, '导入失败：
...
; bad SQL grammar []; nested exception is org.postgresql.util.PSQLException: ERROR: operator does not exist: information_schema.yes_or_no == unknown
  建议：No operator matches the given name and argument type(s). You might need to add explicit type casts.
  位置：45', '2023-01-11 15:14:01.374285');
INSERT INTO "public"."sys_oper_log" VALUES (255, '代码生成', 6, 'com.ruoyi.generator.controller.GenController.importTableSave()', 'POST', 1, 'admin', NULL, '/tool/gen/importTable', '192.168.3.8', '内网IP', '"student"', NULL, 1, '导入失败：
### Error updating database.  Cause: org.postgresql.util.PSQLException: ERROR: null value in column "column_id" violates not-null constraint
  详细：Failing row contains (null, 204, id, id, int4, String, id, t, null, t, 1, null, null, null, EQ, null, null, null, admin, 2023-01-11 15:50:56.046874, null, null).
### The error may exist in file [D:\RuoYi-Vue-master-pg\RuoYi-Vue-master\ruoyi-generator\target\classes\mapper\generator\GenTableColumnMapper.xml]
...
; ERROR: null value in column "column_id" violates not-null constraint
  详细：Failing row contains (null, 204, id, id, int4, String, id, t, null, t, 1, null, null, null, EQ, null, null, null, admin, 2023-01-11 15:50:56.046874, null, null).; nested exception is org.postgresql.util.PSQLException: ERROR: null value in column "column_id" violates not-null constraint
  详细：Failing row contains (null, 204, id, id, int4, String, id, t, null, t, 1, null, null, null, EQ, null, null, null, admin, 2023-01-11 15:50:56.046874, null, null).', '2023-01-11 15:50:56.156262');
INSERT INTO "public"."sys_oper_log" VALUES (256, '代码生成', 6, 'com.ruoyi.generator.controller.GenController.importTableSave()', 'POST', 1, 'admin', NULL, '/tool/gen/importTable', '192.168.3.8', '内网IP', '"student"', '{"msg":"操作成功","code":200}', 0, NULL, '2023-01-11 15:52:27.30799');
INSERT INTO "public"."sys_oper_log" VALUES (257, '代码生成', 6, 'com.ruoyi.generator.controller.GenController.importTableSave()', 'POST', 1, 'admin', NULL, '/tool/gen/importTable', '192.168.3.8', '内网IP', '"teacher"', '{"msg":"操作成功","code":200}', 0, NULL, '2023-01-11 15:58:44.442052');
INSERT INTO "public"."sys_oper_log" VALUES (258, '代码生成', 2, 'com.ruoyi.generator.controller.GenController.editSave()', 'PUT', 1, 'admin', NULL, '/tool/gen', '192.168.3.8', '内网IP', '{"businessName":"teacher","className":"Teacher","columns":[{"capJavaField":"Id","columnComment":"id","columnId":3,"columnName":"id","columnType":"int4","createBy":"admin","createTime":"2023-01-11 15:58:44","edit":false,"increment":false,"insert":true,"isInsert":"1","isPk":"t","isRequired":"t","javaField":"id","javaType":"Integer","list":false,"params":{},"pk":false,"query":false,"queryType":"EQ","required":false,"superColumn":false,"tableId":206,"usableColumn":false},{"capJavaField":"Name","columnComment":"教师姓名","columnId":4,"columnName":"name","columnType":"varchar","createBy":"admin","createTime":"2023-01-11 15:58:44","edit":true,"htmlType":"input","increment":false,"insert":true,"isEdit":"1","isInsert":"1","isList":"1","isPk":"f","isQuery":"1","isRequired":"f","javaField":"name","javaType":"String","list":true,"params":{},"pk":false,"query":true,"queryType":"LIKE","required":false,"superColumn":false,"tableId":206,"usableColumn":false},{"capJavaField":"Phone","columnComment":"教师电话","columnId":5,"columnName":"phone","columnType":"varchar","createBy":"admin","createTime":"2023-01-11 15:58:44","edit":true,"htmlType":"input","increment":false,"insert":true,"isEdit":"1","isInsert":"1","isList":"1","isPk":"f","isQuery":"1","isRequired":"f","javaField":"phone","javaType":"String","list":true,"params":{},"pk":false,"query":true,"queryType":"EQ","required":false,"superColumn":false,"tableId":206,"usableColumn":false}],"crud":true,"functionAuthor":"ruoyi","functionName":"教师","moduleName":"school","options":"{\"parentMenuId\":4}","packageName":"com.ruoyi.system","params":{"parentMenuId":4},"parentMenuId":"4","sub":false,"subTableFkName":"","subTableName":"","tableComment":"教师表","tableId":206,"tableName":"teacher","tplCategory":"crud","tree":false}', '{"msg":"操作成功","code":200}', 0, NULL, '2023-01-11 16:00:59.716278');
INSERT INTO "public"."sys_oper_log" VALUES (259, '代码生成', 2, 'com.ruoyi.generator.controller.GenController.editSave()', 'PUT', 1, 'admin', NULL, '/tool/gen', '192.168.3.8', '内网IP', '{"businessName":"teacher","className":"Teacher","columns":[{"capJavaField":"Id","columnComment":"id","columnId":3,"columnName":"id","columnType":"int4","createBy":"admin","createTime":"2023-01-11 15:58:44","edit":false,"increment":false,"insert":true,"isInsert":"1","isPk":"t","isRequired":"t","javaField":"id","javaType":"Integer","list":false,"params":{},"pk":false,"query":false,"queryType":"EQ","required":false,"superColumn":false,"tableId":206,"updateTime":"2023-01-11 16:00:59","usableColumn":false},{"capJavaField":"Name","columnComment":"教师姓名","columnId":4,"columnName":"name","columnType":"varchar","createBy":"admin","createTime":"2023-01-11 15:58:44","edit":true,"htmlType":"input","increment":false,"insert":true,"isEdit":"1","isInsert":"1","isList":"1","isPk":"f","isQuery":"1","isRequired":"f","javaField":"name","javaType":"String","list":true,"params":{},"pk":false,"query":true,"queryType":"LIKE","required":false,"superColumn":false,"tableId":206,"updateTime":"2023-01-11 16:00:59","usableColumn":false},{"capJavaField":"Phone","columnComment":"教师电话","columnId":5,"columnName":"phone","columnType":"varchar","createBy":"admin","createTime":"2023-01-11 15:58:44","edit":true,"htmlType":"input","increment":false,"insert":true,"isEdit":"1","isInsert":"1","isList":"1","isPk":"f","isQuery":"1","isRequired":"f","javaField":"phone","javaType":"String","list":true,"params":{},"pk":false,"query":true,"queryType":"EQ","required":false,"superColumn":false,"tableId":206,"updateTime":"2023-01-11 16:00:59","usableColumn":false}],"crud":true,"functionAuthor":"ruoyi","functionName":"教师","moduleName":"school","options":"{\"parentMenuId\":\"4\"}","packageName":"com.ruoyi.system","params":{"parentMenuId":"4"},"parentMenuId":"4","sub":false,"subTableFkName":"","subTableName":"","tableComment":"教师表","tableId":206,"tableName":"teacher","tplCategory":"crud","tree":false}', '{"msg":"操作成功","code":200}', 0, NULL, '2023-01-11 16:01:18.03572');
INSERT INTO "public"."sys_oper_log" VALUES (260, '代码生成', 8, 'com.ruoyi.generator.controller.GenController.batchGenCode()', 'GET', 1, 'admin', NULL, '/tool/gen/batchGenCode', '192.168.3.8', '内网IP', '{"tables":"teacher"}', NULL, 0, NULL, '2023-01-11 16:01:24.645075');
INSERT INTO "public"."sys_oper_log" VALUES (261, '代码生成', 2, 'com.ruoyi.generator.controller.GenController.editSave()', 'PUT', 1, 'admin', NULL, '/tool/gen', '192.168.3.8', '内网IP', '{"businessName":"teacher","className":"Teacher","columns":[{"capJavaField":"Id","columnComment":"id","columnId":3,"columnName":"id","columnType":"int4","createBy":"admin","createTime":"2023-01-11 15:58:44","edit":false,"increment":false,"insert":true,"isInsert":"1","isPk":"t","isRequired":"t","javaField":"id","javaType":"Integer","list":false,"params":{},"pk":false,"query":false,"queryType":"EQ","required":false,"superColumn":false,"tableId":206,"updateTime":"2023-01-11 16:01:17","usableColumn":false},{"capJavaField":"Name","columnComment":"教师姓名","columnId":4,"columnName":"name","columnType":"varchar","createBy":"admin","createTime":"2023-01-11 15:58:44","edit":true,"htmlType":"input","increment":false,"insert":true,"isEdit":"1","isInsert":"1","isList":"1","isPk":"f","isQuery":"1","isRequired":"f","javaField":"name","javaType":"String","list":true,"params":{},"pk":false,"query":true,"queryType":"LIKE","required":false,"superColumn":false,"tableId":206,"updateTime":"2023-01-11 16:01:17","usableColumn":false},{"capJavaField":"Phone","columnComment":"教师电话","columnId":5,"columnName":"phone","columnType":"varchar","createBy":"admin","createTime":"2023-01-11 15:58:44","edit":true,"htmlType":"input","increment":false,"insert":true,"isEdit":"1","isInsert":"1","isList":"1","isPk":"f","isQuery":"1","isRequired":"f","javaField":"phone","javaType":"String","list":true,"params":{},"pk":false,"query":true,"queryType":"EQ","required":false,"superColumn":false,"tableId":206,"updateTime":"2023-01-11 16:01:17","usableColumn":false}],"crud":true,"functionAuthor":"liusuyi","functionName":"教师","moduleName":"school","options":"{\"parentMenuId\":\"4\"}","packageName":"com.ruoyi.system","params":{"parentMenuId":"4"},"parentMenuId":"4","sub":false,"subTableFkName":"","subTableName":"","tableComment":"教师表","tableId":206,"tableName":"teacher","tplCategory":"crud","tree":false}', '{"msg":"操作成功","code":200}', 0, NULL, '2023-01-11 16:02:45.185635');
INSERT INTO "public"."sys_oper_log" VALUES (262, '代码生成', 8, 'com.ruoyi.generator.controller.GenController.batchGenCode()', 'GET', 1, 'admin', NULL, '/tool/gen/batchGenCode', '192.168.3.8', '内网IP', '{"tables":"teacher"}', NULL, 0, NULL, '2023-01-11 16:02:47.982505');
...
INSERT INTO "public"."sys_role" VALUES (2, '普通角色', 'common', 2, '2', 't', 't', '0', '0', 'admin', '2023-01-11 08:15:25', '', NULL, '普通角色');
...
-- Records of sys_user
-- ----------------------------
INSERT INTO "public"."sys_user" VALUES (2, 105, 'ry', '若依', '00', 'ry@qq.com', '15666666666', '1', '', '$2a$10$7JB720yubVSZvUI0rEqK/.VqGOZTH.ulu33dHOiBE8ByOhJIrdAu2', '0', '0', '127.0.0.1', '2023-01-11 08:15:25', 'admin', '2023-01-11 08:15:25', '', NULL, '测试员');
INSERT INTO "public"."sys_user" VALUES (3, 203, 'liusuyi', '刘苏义', NULL, NULL, NULL, '0', NULL, '$2a$10$79QjypY7bUn9q8hY59uH3uOsWngurBJSh2IC9xGvX2gSSzViYBCjC', '0', '0', NULL, NULL, 'admin', '2023-01-11 11:59:14.135452', NULL, NULL, NULL);
INSERT INTO "public"."sys_user" VALUES (1, 103, 'admin', '若依', '00', 'ry@163.com', '15888888888', '1', '', '$2a$10$7JB720yubVSZvUI0rEqK/.VqGOZTH.ulu33dHOiBE8ByOhJIrdAu2', '0', '0', '192.168.3.8', '2023-01-11 15:50:39.796', 'admin', '2023-01-11 08:15:25', '', '2023-01-11 15:50:42.554006', '管理员');
